...
const Navbar = () => {
  ...
  return (
    <nav className='px-[2rem] lg:px-[6rem] xl:px-[12rem] py-4 flex justify-between'>
      <h1 className='text-white font-montserrat font-bold text-xl md:text-2xl p-2'>ARNAS.</h1>
      ...
      <div onClick={navHandle} className="block p-2 md:hidden">
