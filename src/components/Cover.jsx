...
const Cover = () => {
  return (
    <div className="w-screen lg:h-[90vh] h-max mt-8 md:mt-0 px-6 md:px-[8rem] 2xl:px-[12rem]">
      <div className="w-full h-full md:grid md:grid-cols-2">
        <div className="flex flex-col justify-center font-poppins">
          <h2 className="text-3xl 2xl:text-5xl font-medium text-[#A0A0A0] ">
            <Typed
          ...
          <h1 className="text-4xl md:text-5xl 2xl:text-7xl font-bold text-white mt-2 md:mt-4">
            Syaefulloh Arnas
          </h1>
          <div className="bg-[#FFD568] w-[50%] md:w-[40%] h-[4px] md:h-[6px] rounded-lg my-4 md:my-8 lg:my-10"></div>
          <p className="text-sm md:text-md lg:text-lg text-white leading-8 md:leading-10 font-light md:w-3/4">
            During my college days I participated in several internal activities
            as a designer such as designing ui/ux and filling in Instagram
            content using <span className="font-bold">Figma</span> and{" "}
            <span className="font-bold">Adobe XD</span>. Besides that, I have
            made website projects with
            ...
            <span className="font-bold"> Python</span>. If you want to get more
            information from me, you can contact me. Thank You
          </p>
          <a
            className="text-[#FFD568] flex items-center gap-5 hover:gap-10 ease-in-out duration-200 text-lg md:text-xl mt-12 w-max"
            href="http://"
          >
